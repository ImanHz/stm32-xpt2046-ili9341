...
static void GPIO_read(void)
{
  ...
  GPIO_InitStruct.Pin = LCD_D2_Pin|LCD_D1_Pin|LCD_D0_Pin;
...
//***************************************************************************
void ILI9341_drawChar(int16_t x, int16_t y, unsigned char c, uint16_t color, uint16_t bg, uint8_t size,const GFXfont *f)
{
...
//***************************************************************************
void ILI9341_printText(char text[], int16_t x, int16_t y, uint16_t color, uint16_t bg, uint8_t size,const GFXfont *f)
{
	int16_t offset;
	offset = size*8;
	for(uint16_t i=0; i<40 && text[i]!=NULL; i++)
	{
		ILI9341_drawChar(x+(offset*i), y, text[i],color,bg,size,f);
	}
}
//***************************************************************************
